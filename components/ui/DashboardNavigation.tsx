              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <div key={item.name} className="relative group">
                    ...
                    {item.isPlaceholder && (
                      <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-background border border-cornflower-blue/30 rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 whitespace-nowrap">
                        <p className="text-sm text-foreground">{item.description}</p>
                        <p className="text-xs text-cornflower-blue mt-1 font-medium">Coming soon!</p>
                        {/* Tooltip arrow pointing up */}
                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-b-4 border-l-transparent border-r-transparent border-b-cornflower-blue/30"></div>
                      </div>
                    )}
                  </div>
                )
