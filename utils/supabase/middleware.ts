...
export async function updateSession(request: NextRequest) {
  ...
  const isProtectedRoute = path.startsWith('/dashboard') || path.startsWith('/account') || path.startsWith('/progress') || 
                          (path.startsWith('/profile') && path !== '/profile') || // Allow public profile but protect /profile/create etc
