...
class MultiGoalOrchestrator {
    constructor() {
        ...
        this.supportedGoals = [
            'strength', 'hypertrophy', 'weight_loss', 'sports_performance', 
    ...
    prioritizeGoals(selectedGoals) {
        ...
        const secondaryGoals = validGoals.slice(1, 5); // Limit to 4 secondary goals
...
module.exports = MultiGoalOrchestrator;als
