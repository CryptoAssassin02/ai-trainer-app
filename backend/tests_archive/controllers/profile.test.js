...
// Mock the env config module BEFORE other imports
jest.mock('../../config/env.js', () => ({
  ...
  auth: {
    jwtSecret: 'mock-test-jwt-secret-needs-32-chars-or-more',
    jwtExpiresIn: '15m',
...
// Mock the services/supabase.js module
jest.mock('../../services/supabase');

// Only require the controller after mocking dependencies
